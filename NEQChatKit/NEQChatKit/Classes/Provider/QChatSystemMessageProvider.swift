...
public class QChatSystemMessageProvider: NSObject {
  ...
  public func getMessageHistory(param: NEQChatGetMessageHistoryParam,
  ...
  public func markMessageRead(param: NEQChatMarkMessageReadParam,
                              _ completion: @escaping (Error?) -> Void) {
  ...
  public func removeDelegate(delegate: NIMQChatMessageManagerDelegate) {
    NIMSDK.shared().qchatMessageManager.remove(delegate)
  }
}
