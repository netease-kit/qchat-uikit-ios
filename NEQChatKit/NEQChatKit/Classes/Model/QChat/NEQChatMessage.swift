...
//    消息投递状态 仅针对发送的消息
  var deliveryState: NEQChatMessageDeliveryState?
//    消息附件下载状态 仅针对收到的消息
  var attachmentDownloadState: NEQChatMessageAttachmentDownloadState?
//    是否是收到的消息
...
//    消息是否标记为已删除
  ...
  var status: NEQChatMessageState?
