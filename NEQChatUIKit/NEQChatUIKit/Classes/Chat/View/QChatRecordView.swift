...
public protocol QChatRecordViewDelegate: NSObjectProtocol {
  func startRecord()
  func moveOutView()
  func moveInView()
...
@objcMembers
public class QChatRecordView: UIView, UIGestureRecognizerDelegate {
  var recordImageView = UIImageView()
  var topTipLabel = UILabel()
  var tipLabel = UILabel()
  public weak var delegate: QChatRecordViewDelegate?
  ...
  func commonUI() {
    ...
    topTipLabel.text = coreLoader.localizable("send_after_let_go")
    ...
    tipLabel.text = coreLoader.localizable("press_speak")
