...
//    MARK: text color
  ...
  static let ne_disableBlueText = UIColor(hexString: "#337EFF", 0.5)
...
//    MARK： line color
  ...
  // 管理员标签文本颜色
  static let ne_adminLabelTextColor = UIColor(hexString: "#656A72")
  static let ne_adminLabelBackColor = UIColor(hexString: "#D6D8DB")
  static let ne_adminLabelBorderColor = UIColor(hexString: "#F7F7F7")

  /// 无法点击背景色
  static let ne_noInteractionColor = UIColor(hexString: "#EFF1F3")

  static let ne_noticeTagBackgroundColor = UIColor(hexString: "#72747B")
}
