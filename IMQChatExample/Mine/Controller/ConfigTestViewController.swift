...
class ConfigTestViewController: NEBaseViewController, UITableViewDelegate,
  ...
  func getSectionData() -> SettingSectionModel {
    ...
    showTeam.switchOpen = QChatKitClient.instance.getConfigCenter().teamEnable
    showTeam.swichChange = { isOpen in
      QChatKitClient.instance.getConfigCenter().teamEnable = isOpen
    }
  ...
  @objc func saveConfig() {
    NotificationCenter.default.post(
      name: Notification.Name("refreshUI"),
      object: nil
    )
  }
