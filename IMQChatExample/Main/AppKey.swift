...
public var account: String {
  UserDefaults.standard.string(forKey: "qchat_config_account") ?? "<#account#>"
}

/// token 优先从本地存储读取
public var token: String {
  UserDefaults.standard.string(forKey: "qchat_config_token") ?? "<#token#>"
}
...
public struct AppKey {
    ...
    public static var appKey: String {
      UserDefaults.standard.string(forKey: "qchat_config_appKey") ?? "<#请输入云信 AppKey#>"
    }
