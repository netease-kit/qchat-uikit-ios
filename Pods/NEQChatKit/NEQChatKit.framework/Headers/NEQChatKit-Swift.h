...
#ifndef NEQCHATKIT_SWIFT_H
#define NEQCHATKIT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="NEQChatKit",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

#if defined(__OBJC__)
@class QChatRoleProvider;
@class QChatServerProvider;
@class QChatChannelProvider;
@class FriendProvider;
@class UserInfoProvider;
@class QChatMessageProvider;
@class SettingProvider;
@class QChatApnsProvider;
@protocol QChatRepoMessageDelegate;
...
SWIFT_CLASS("_TtC10NEQChatKit9QChatRepo")
@interface QChatRepo : NSObject
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) QChatRepo * _Nonnull shared;)
+ (QChatRepo * _Nonnull)shared SWIFT_WARN_UNUSED_RESULT;
@property (nonatomic, readonly, strong) QChatRoleProvider * _Nonnull roleProvider;
@property (nonatomic, readonly, strong) QChatServerProvider * _Nonnull serverProvider;
@property (nonatomic, readonly, strong) QChatChannelProvider * _Nonnull channelProvider;
...
@property (nonatomic, readonly, strong) QChatMessageProvider * _Nonnull messageProvider;
@property (nonatomic, readonly, strong) SettingProvider * _Nonnull settingProvider;
@property (nonatomic, readonly, strong) QChatApnsProvider * _Nonnull apnsProvider;
@property (nonatomic, weak) id <QChatRepoMessageDelegate> _Nullable delegate;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
/// 消息接收回调
- (void)onReceive:(NSArray<NIMQChatMessage *> * _Nonnull)messages;
/// 未读数变更回调
...
/// 从云信服务器批量获取用户资料
- (void)fetchUserInfoWithAccountList:(NSArray<NSString *> * _Nonnull)accountList :(void (^ _Nonnull)(NSError * _Nullable, NSArray<User *> * _Nullable))completion;
/// 批量获取话题最后一条消息
- (void)getLastMessage:(uint64_t)serverId :(NSArray<NSNumber *> * _Nonnull)channelIds :(void (^ _Nonnull)(NSError * _Nullable, NSDictionary<NSNumber *, NIMQChatMessage *> * _Nullable))completion;
/// 游客模式加入
...
SWIFT_PROTOCOL("_TtP10NEQChatKit24QChatRepoMessageDelegate_")
@protocol QChatRepoMessageDelegate <NSObject>
@optional
- (void)onReceive:(NSArray<NIMQChatMessage *> * _Nonnull)messages;
- (void)onUnReadChange:(NSArray<NIMQChatUnreadInfo *> * _Nullable)unreads :(NSArray<NIMQChatUnreadInfo *> * _Nullable)lastUnreads;
- (void)serverUnreadInfoChanged:(NSDictionary<NSNumber *, NIMQChatServerUnreadInfo *> * _Nonnull)serverUnreadInfoDic;
